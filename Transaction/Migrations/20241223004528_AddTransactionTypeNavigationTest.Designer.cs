...
namespace Transaction.Migrations
{
    ...
    [Migration("20241223004528_AddTransactionTypeNavigationTest")]
    partial class AddTransactionTypeNavigationTest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Transaction.Models.Transactions", b =>
                {
                    ...
                    b.HasOne("Transaction.Models.TransactionType", null)
                        .WithMany()
